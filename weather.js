...
// whatever function that has an await inside must have async in the beginning
// it not to copy their example
// I told you guys to use async/await
// check the example on MDN
// I told you na, .then is replaced by the await style
// / oya change the code to use
